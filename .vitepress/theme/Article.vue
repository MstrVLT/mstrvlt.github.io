...
<template>
  <article class="xl:divide-y xl:divide-gray-200 dark:xl:divide-slate-200/5">
    <header class="pt-6 xl:pb-10 space-y-1 text-center">
      <Date :date="date" />
      <h1
        class="text-2xl leading-9 font-extrabold text-gray-900 dark:text-white tracking-tight"
      >
        {{ data.title }}
      </h1>
    </header>
    ...
    <div
      class="divide-y xl:divide-y-0 divide-gray-200 dark:divide-slate-200/5"
